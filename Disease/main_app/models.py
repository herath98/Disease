...
class DiseaseForSuggestions(models.Model):
    disease = models.CharField(max_length=200, unique=True)
    good_habits = ArrayField(models.CharField(max_length=200))
    good_foods = ArrayField(models.CharField(max_length=200))
    notgoodfoods = ArrayField(models.CharField(max_length=200))
